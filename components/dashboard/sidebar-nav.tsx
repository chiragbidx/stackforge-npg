...
const sections: { title: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { label: "Collections", href: "/dashboard/collections", icon: PlayCircle },
      { label: "Browse", href: "/dashboard/browse", icon: List },
      { label: "Recommended", href: "/dashboard/recommended", icon: Star },
      {
        label: "Feature",
